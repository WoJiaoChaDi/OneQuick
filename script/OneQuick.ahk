...
;            Action can be a label name, function name,                                  ;|
;            even a submenu object, or any command runs in system cmd                    ;|
;           you can read the comments above run() function in OneQuick.Core.             ;|
;           ahk for more information                                                     ;|
;                                                                                        ;|
